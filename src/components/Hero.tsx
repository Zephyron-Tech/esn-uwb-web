        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center">
          ...
          <div className="md:col-span-3 text-center md:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                href="/local-student"
                className="inline-flex items-center justify-center px-8 py-4 bg-esn-orange text-white font-bold rounded-full transition-transform hover:scale-105"
              >
                Buddy for Locals
              </Link>
              <Link
                href="/incoming-student"
                className="inline-flex items-center justify-center px-8 py-4 bg-esn-green text-white font-bold rounded-full transition-transform hover:scale-105"
              >
                Guide for Incomings
              </Link>
            </div>
          ...
          <div className="md:col-span-2 flex justify-center md:justify-end">
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-[340px] md:h-[340px] lg:w-[400px] lg:h-[400px]">
              ...
              <div className="absolute top-0 right-0 w-44 h-44 sm:w-48 sm:h-48 md:w-52 md:h-52 lg:w-60 lg:h-60 rounded-full border-4 border-esn-magenta overflow-hidden shadow-2xl z-30">
                <Image
              ...
              <div className="absolute top-1/4 -left-4 w-36 h-36 sm:w-40 sm:h-40 md:w-44 md:h-44 lg:w-52 lg:h-52 rounded-full border-4 border-esn-green overflow-hidden shadow-2xl z-20">
                <Image
              ...
              <div className="absolute bottom-0 left-1/4 w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full border-4 border-esn-cyan overflow-hidden shadow-2xl z-10">
                <Image
